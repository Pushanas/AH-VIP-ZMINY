  ...
  return (
    ...
    >
      ...
      <div className="mt-8 pt-6 border-t border-white/5 flex flex-col items-center justify-center gap-3">
        <p className="text-xs text-slate-400 font-medium">للاشتراك أو التواصل مع الدعم</p>
        <a 
          href="https://t.me/AH_QUOTEX_SUPPORT" 
          target="_blank" 
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#00F0FF]/10 text-[#00F0FF] hover:bg-[#00F0FF]/20 transition-all border border-[#00F0FF]/20 group"
        >
